...
class updateurl_form extends moodleform {
    ...
    function definition() {
       ...
       // elementos ocultos
        ...
        // Dropdown delimiter
        $select = $mform->addElement('select', 'delimiter', get_string('delimiter', 'block_updateurl'), array(',', ';','.'), $attributes);
        ...
        $mform->addElement('html', '<h1 id="watafak">Hola Mundo!</h1>');
        ...
        // 	'header', 
        // 	'picfield', 
        // 	get_string('picturefields', 'block_updateurl'), 
        // 	null, 
        // 	false
        // );
        ...
        //     'selectyesno', 
        //     'displaypicture', 
        //     get_string('displaypicture', 'block_updateurl')
        // );
